// Temperature.cpp : Defines the entry point for the console application.
//
...
Int16 DecodeMeasurement16( byte inbyByte3, byte inbyByte4, double& outdblFloatValue, Int16& outi16DecimalPointPosition)
{
